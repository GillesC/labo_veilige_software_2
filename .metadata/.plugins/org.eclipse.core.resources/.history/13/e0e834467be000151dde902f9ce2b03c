	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			*/
			...
			if (r.getSW()!=0x9000) throw new Exception("Serial Number request failed "+ r.getSW());
			...
			if (r.getSW()!=0x9000) throw new Exception("Name request failed");
			if(r.getSW()==SW_PIN_VERIFICATION_REQUIRED) throw new Exception("PIN verification is required");
